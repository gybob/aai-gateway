...
AAI Gateway: **한마디로 Agent가 자동 검색, 설치, 즉시 사용 가능**.

> "회사 소개 PPT를 만들고 싶어"
>
> → Agent가 PPT 스킬 부족 감지 → PPT Skill 자동 검색 및 설치 → 제작 가이드, 재시작 불필요

> "이 웹페이지 내용 가져와줘"
>
> → Agent가 웹 스크래핑 도구 부족 감지 → 해당 MCP 자동 검색 및 설치 → 바로 가져오기, 재시작 불필요
